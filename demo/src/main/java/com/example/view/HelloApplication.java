...
import model.backend.ClientHandler;
...
//                    System.out.println("IP address: " + addr.getHostAddress()); // check mi ip wifi address
        ...
        Image backgroundImage = new Image("file:src/main/java/com/example/view/scrabblePhoto.jpg");
    ...
    private void askForIp(Button multiplayerButton) {
        multiplayerButton.setFont(Font.font("Arial", FontWeight.BOLD, 18));
